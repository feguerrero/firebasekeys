...
@property (class, readonly) NSString *KEY_ONE __attribute__((swift_name("KEY_ONE")));
@property (class, readonly) NSString *KEY_THREE __attribute__((swift_name("KEY_THREE")));
@property (class, readonly) NSString *KEY_TWO __attribute__((swift_name("KEY_TWO")));
@end;
